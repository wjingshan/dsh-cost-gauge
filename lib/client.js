...
`
    ...
    function renderPill(pillG, text) {
      pillG.textContent = ''
      // 时间胶囊：下移一个高度（14px）并放大。
      const rect = svgEl('rect', { class: 'dsg-pill', x: '70', y: '59', width: '60', height: '17', rx: '8.5' })
      const t = svgEl('text', { class: 'dsg-pill-text dsg-time-text', x: '100', y: '67.5' })
      t.textContent = text
