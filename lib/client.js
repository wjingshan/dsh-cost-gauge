...
.dsg-title-text{flex:1;font-size:13px;font-weight:600;color:#f3f4f6;white-space:nowrap;overflow:hidden}
.dsg-badge{flex:none;font-size:10px;line-height:1;padding:2px 5px;border:1px solid rgba(255,255,255,.4);
  border-radius:5px;color:#cbd5e1;font-weight:600;letter-spacing:.2px;white-space:nowrap}
