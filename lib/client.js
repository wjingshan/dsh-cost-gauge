...
<defs>
  ...
  <filter id="dsg-stack-green" x="-30%" y="-30%" width="160%" height="160%"><feDropShadow dx="0" dy="1.5" stdDeviation="1.2" flood-color="#000000" flood-opacity="0.45"/></filter>
      ...
      return {
        id: 'classic', name: '经典时钟', collapsible: true,
        build(el, st) {
          el.innerHTML = `
...
<div class="dsg-clock">
  <svg viewBox="0 0 200 200" aria-label="费率时钟">${DEFS}
    ...
    <g class="dsg-ring"></g><g class="dsg-odo"></g>
...
<div class="dsg-compact">
  ...
  <div class="dsg-row"><span>余额</span><span class="dsg-val dsg-balance2">—</span></div>
          ...
          function renderRing() {
            ...
            const key = `${st.isWeekend()}|${isPM}|${w}|${busy}|${idle}`
            if (key !== lastRingKey) {
              lastRingKey = key
              buildClockRing(ringEl, st.isWeekend(), isPM, w, busy, idle)
            }
          }
...
<div class="dsg-bar">
  ...
  <span class="dsg-bar-item"><i>余额</i><b class="dsg-bar-bal">—</b></span>
    ...
    const SKINS = [classicSkin(), minimalSkin(), ringSkin(), barSkin()]
    const SKIN_BY_ID = {}
