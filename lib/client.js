...
.dsg-needle{transform-box:view-box;transform-origin:70px 70px;transform:rotate(-90deg);
  transition:transform .6s linear;filter:drop-shadow(0 0 3px rgba(255,255,255,.35))}
.dsg-needle .dsg-hand{stroke:#ffffff;stroke-width:4;stroke-linecap:round}
.dsg-needle .dsg-tail{stroke:rgba(255,255,255,.4);stroke-width:2;stroke-linecap:round}
.dsg-needle .dsg-cap{fill:#ffffff}
...
.dsg-statusline{display:flex;align-items:center;justify-content:center;gap:8px;
  font-size:12px;margin-top:5px;min-height:20px}
.dsg-status.dsg-std{color:#4ade80}
.dsg-status.dsg-peak{color:#fbbf24}
.dsg-countdown{color:#8b8f98;font-size:11px;font-variant-numeric:tabular-nums}
