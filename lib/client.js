...
.dsg-meta{display:flex;justify-content:center;gap:30px;margin-top:5px}
.dsg-meta-col{display:flex;flex-direction:column;align-items:center;gap:2px;min-width:0}
