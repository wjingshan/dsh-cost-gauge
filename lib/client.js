...
.dsg-flapboard{position:absolute;left:50%;top:36%;transform:translate(-50%,-50%);
  display:flex;align-items:center;gap:2px;background:var(--dsg-pill-bg);
  border:1px solid var(--dsg-pill-border);border-radius:8px;padding:3px 6px;box-sizing:border-box}
.dsg-flap-cell{position:relative;width:17px;height:23px;overflow:hidden;perspective:100px;
...
.dsg-flap-colon{font-size:16px;font-weight:700;color:var(--dsg-fg);padding:0 1px;line-height:1}
...
.dsg-pill{fill:var(--dsg-pill-bg);stroke:var(--dsg-pill-border);stroke-width:.8}
