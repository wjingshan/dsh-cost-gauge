...
.dsg-busy .dsg-lamp.dsg-lamp-busy .dsg-lamp-dot{
  animation:dsg-lamp-breathe 5s linear infinite;
  filter:drop-shadow(0 0 4px currentColor)
}
@keyframes dsg-lamp-breathe{
  0%{opacity:.5}12.5%{opacity:.72}25%{opacity:.87}37.5%{opacity:.96}
  50%{opacity:1}62.5%{opacity:.96}75%{opacity:.87}87.5%{opacity:.72}100%{opacity:.5}
}
