...
.dsg-bal-track{fill:none;stroke:rgba(255,255,255,.10);stroke-width:5;stroke-linecap:round}
.dsg-bal-fill{fill:none;stroke:url(#dsg-bal-grad);stroke-width:5;stroke-linecap:round;opacity:.9;transition:stroke .3s}
.dsg-root.dsg-alarm .dsg-bal-fill{stroke:#ef4444}
.dsg-bal-mark{stroke:rgba(255,255,255,.85);stroke-width:1.6;stroke-linecap:round;opacity:.9}
.dsg-needle{transform-box:view-box;transform-origin:70px 70px;transform:rotate(-90deg);
  transition:transform .6s linear;filter:drop-shadow(1px 2px 2px rgba(0,0,0,.5))}
