...
.\install-dsh-cost-gauge.ps1 -Ref v1.2.0      # pin a tag
```
...
dsh plugin --profile web add github:wjingshan/dsh-cost-gauge#v1.2.0

# tarball, no git required
dsh plugin --profile web add https://github.com/wjingshan/dsh-cost-gauge/archive/refs/tags/v1.2.0.tar.gz
